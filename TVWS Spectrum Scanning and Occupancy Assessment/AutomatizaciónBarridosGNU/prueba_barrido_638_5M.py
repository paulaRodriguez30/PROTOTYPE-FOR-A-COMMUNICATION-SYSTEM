...
class prueba_barrido_638_5M(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "prueba_barrido_638_5M")
        ...
        self._freq_range = qtgui.Range(470e6, 710e6, 10e6, 638.5e6, 200)
        ...
        self.qtgui_freq_sink_x_1.set_y_axis((-250), 10)
        ...
        self.filerepeater_VectorToTxtFile_1 = filerepeater.VectorToTxtFile('C:\\Users\\USUARIO\\Downloads\\638_5M.csv', vec_len, freq, samp_rate, '', True, 30, 2, True)
        ...
        self.blocks_multiply_const_xx_0 = blocks.multiply_const_cc(0.000976562, vec_len)
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(vec_len)
        self._amp_range = qtgui.Range(-11, 11, 0.500, 1, 200)
        ...
        self.connect((self.blocks_nlog10_ff_0, 0), (self.filerepeater_VectorToTxtFile_1, 0))
...
def main(top_block_cls=prueba_barrido_638_5M, options=None):
