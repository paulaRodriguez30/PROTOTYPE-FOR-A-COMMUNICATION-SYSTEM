...
class prueba_barrido_651M(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "prueba_barrido_651M")
        ...
        self._freq_range = qtgui.Range(470e6, 710e6, 10e6, 651e6, 200)
        ...
        self.filerepeater_VectorToTxtFile_1 = filerepeater.VectorToTxtFile('C:\\Users\\USUARIO\\Downloads\\651M.csv', vec_len, freq, samp_rate, '', True, 30, 2, True)
...
def main(top_block_cls=prueba_barrido_651M, options=None):
