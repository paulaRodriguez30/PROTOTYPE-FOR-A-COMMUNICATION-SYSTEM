...
class GMSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = qtgui.Range(470, 698, 0.05, 470, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "Frecuencia centro", "counter_slider", float, QtCore.Qt.Horizontal)
        self.controls_grid_layout_0.addWidget(self._freq_win, 0, 2, 1, 1)
        for r in range(0, 1):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range((self.freq*1e6), self.samp_rate)
